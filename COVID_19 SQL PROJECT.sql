...
-- DISPLAY THE NUMBER OF ROWS IN COVID-19 TABLE
SELECT COUNT(*)
FROM COVID_19;
...
-- 10.RECOVERY RATE
SELECT CONTINENT,(SUM(TOTALRECOVERED)/SUM(TOTALCASES))*100 AS RECOVERY_RATE
FROM COVID_19
GROUP BY CONTINENT
...
-- 11. LOOKING AT INDIA'S DEATH AND CASE PERCENTAGE
...
-- 26. SHOW THE STRUCTURE OF THE TABLE
DESCRIBE COVID_19;


-- 27.TO SEE IF THERE ARE NO DUPLICATE ENTRIES IN COUNTRY COLUMN
...
-- 28. ASSIGN PRIMARY KEY CONSTRAINT TO COLUMN NAME COUNTRY
SELECT * FROM COVID_19
...
-- 29. TO REPLACE MISSING VALUES WITH NULL
UPDATE COVID_19
SET WHO_REGION=NULL
WHERE (WHO_REGION)='';


-- 30.TO LOOK AT ALL THE COUNTRIES WITH NO WHO_REGION
SELECT COUNTRY,CONTINENT,WHO_REGION
FROM COVID_19
WHERE WHO_REGION IS NULL;


-- 31.DISPLAY THE NUMBER OF NULL VALUES IN WHO_REGION COLUMN
SELECT COUNT(*) 
FROM COVID_19
WHERE WHO_REGION IS NULL; 


-- 32.LOOKING AT THE HIGHEST,LOWEST AND AVERAGE OF TOTAL CASES OF ALL CONTINENTS
